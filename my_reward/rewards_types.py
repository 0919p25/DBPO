...
class RewardConfig:
    ...
    think_format_reward: float = 0.05
    box_format_reward: float = 0.05
    format_error_reward: float = -0.1
    unk_error_reward: float = 0.0
    sigmoid_reward: bool = False
    linear_reward: bool = True
    base_budget: int = 500
    alpha: float = 0.3
    beta: float = 0.3
    difficulty_growth_factor: float = 1.56
    use_normalized_penalty: bool = True
    max_budget_multiplier: float = 32.0
    ...
    def __post_init__(self):
        assert not (self.sigmoid_reward and self.linear_reward), \
            "sigmoid_reward and linear_reward are mutually exclusive"
